...
This repository contains a plugin to allow the *-log plugins content to be customised. This feature required the PDK *kong.log.set_serialize_value* function which is available from Kong 2.3
